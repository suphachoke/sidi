...
public class WSExecutionFast {
    ...
    public WSExecutionFast(OntModel dat, String cn, OntModel owlsm, String ns) {
        this.exns = ns;
        this.data = dat;
        this.casename = cn;
        if (owlsm != null) {
                                                    ...
                                                    for (int jj = 0; jj < itw_arr.size(); jj++) {
                                                        ...
                                                        if (outm.getPropertyValue(this.owls_messpart).toString().split("\\^\\^")[0].equals(nd_name)) {
                                                            ...
                                                            if (param.getPropertyValue(this.owls_paramClsType) != null) {
                                                                ...
                                                                genid = "_" + genid;
                                                                genid2 = cls.getLocalName() + genid2;
                                                                //System.out.println("Class:" + cls.getURI());
                                                            } else if (param.hasProperty(this.owls_paramType)) {
                                                                cls = this.owls.getOntClass(param.getPropertyValue(this.owls_paramType).toString());
                                                                genid = "_" + genid;
                                                                genid2 = cls.getLocalName() + genid2;
                                                            }
                                                        } else {
